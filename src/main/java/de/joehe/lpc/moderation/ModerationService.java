...
public final class ModerationService {
    ...
    public ModerationService(JoehesLPC plugin, MuteService muteService) {
        this.plugin = plugin;
    ...
    public ModResult process(Player player, String raw) {
        ...
        if (spamEnabled && !player.hasPermission("JoehesLPC.bypass.spam")) {
        ...
        if (repeatEnabled && !player.hasPermission("JoehesLPC.bypass.repeat")) {
        ...
        if (capsEnabled && !player.hasPermission("JoehesLPC.bypass.caps")
        ...
        if (profanityEnabled && !player.hasPermission("JoehesLPC.bypass.profanity")
        ...
        if (advertEnabled && !player.hasPermission("JoehesLPC.bypass.advert")
