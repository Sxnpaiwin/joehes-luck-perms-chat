...
public final class ChatFormatService {
    ...
    public ChatFormatService(JoehesLPC plugin) {
        this.plugin = plugin;
    ...
    public Component render(Player source, Component message, Component displayName) {
        ...
        format = LegacyColors.toMiniMessage(format);
    ...
    private String applyMetaTokens(String format, Player source, CachedMetaData metaData, Component displayName) {
        return format
                .replace("{prefix}", LegacyColors.toMiniMessage(orEmpty(metaData.getPrefix())))
                .replace("{suffix}", LegacyColors.toMiniMessage(orEmpty(metaData.getSuffix())))
                .replace("{prefixes}", LegacyColors.toMiniMessage(String.join(" ", metaData.getPrefixes().values())))
                .replace("{suffixes}", LegacyColors.toMiniMessage(String.join(" ", metaData.getSuffixes().values())))
                ...
                .replace("{username-color}", LegacyColors.toMiniMessage(orEmpty(metaData.getMetaValue("username-color"))))
                .replace("{message-color}", LegacyColors.toMiniMessage(orEmpty(metaData.getMetaValue("message-color"))));
    }
